-- Informações de status das threads, ou seja: Running, suspended. 
...
-- Informações de yelds de uma thread, por exemplo: Quantas vezes uma thread fez yeld, quantos IOs ele tem pendentes, load factor entre outros.
...
-- O que está esperando, por quanto tempo está esperando, o que recurso que está sendo aguardado. 
...
-- informações incrementais de todos os workers
...
-- informações completas sobre os works/threads
SELECT   
    t1.session_id,
    t4.program_name,
