...
alter procedure sp_rebuild_index 
(
		@db_rebuild varchar(500) = null
		,@db_except varchar(500) = null
		,@maxdop tinyint = 0 
		,@rebuild_table bit = 1
				...
				select @exec_check = 0, 
						...
						case when @indexsize > @logfile_freespace 
								then 'por falta de espaço no transaction log, espaço necessário: '
									+cast(@indexsize as varchar)+'MB espaço disponível: '+cast(@logfile_freespace as varchar)+'MB'
